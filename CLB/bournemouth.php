...
<body>
    <div class="header">
        <img src="../logo/Bournemouth.png" alt="Bournemouth Logo" class="logo">
        <h1>Bournemouth</h1>
        ...
        <p>
            ...
            Official Website: <a href="https://www.afcb.co.uk/">www.afcb.co.uk</a>
        </p>
        <p>
    ...
    <nav class="navbar navbar-expand-lg" style="background-color:rgb(0, 0, 0);">
        <div class="container">
            ...
            <a class="navbar-brand" href="#">
                <img src="../logo/Bournemouth.png" style="width: 70px;" alt="Logo">
            </a>
    ...
    <div class="content">
        <center><img src="../stadiumFC/Bournemouth.png" alt="Vitality"></center>
        <center>
